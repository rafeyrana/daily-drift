...
import { createEllipseCenterline } from './TrackUtil';
export function createOvalTrack(majorRadius, minorRadius, width, samples, enableWalls = true) {
...
function createTrackRibbon(centerlineSamples, width) {
...
function createStartLine(firstSample, trackWidth) {
...
function createTrackWalls(centerlineSamples, trackWidth) {
...
//# sourceMappingURL=OvalTrack.js.map