...
export function findNearestOnCenterline(position, centerlineSamples) {
...
export function isOffTrack(lateralDistance, trackWidth, tolerance = 0.4) {
    return Math.abs(lateralDistance) > (trackWidth / 2 + tolerance);
}
export function createEllipseCenterline(majorRadius, minorRadius, samples) {
    const centerline = [];
...
//# sourceMappingURL=TrackUtil.js.map